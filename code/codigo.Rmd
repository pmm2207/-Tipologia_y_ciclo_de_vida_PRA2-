...
```{r warning=FALSE, cache=FALSE, message=FALSE}
summary(data_wine$fixed_acidity)
boxplot(data_wine$fixed_acidity, col="orange3")
```
...
boxplot(data_wine$volatile_acidity, col="orange3")
```
...
boxplot(data_wine$citric_acid, col="orange3")
```
...
boxplot(data_wine$residual_sugar, col="orange3")
```
...
boxplot(data_wine$chlorides, col="orange3")
```
...
boxplot(data_wine$free_sulfur_dioxide, col="orange3")
```
...
boxplot(data_wine$total_sulfur_dioxide, col="orange3")
```
...
boxplot(data_wine$density, col="orange3")
```
...
boxplot(data_wine$alcohol, col="orange3")
```
